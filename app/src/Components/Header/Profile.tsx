...
const Profile = () => {
  ...
  return (
    <div
      className="flex items-center cursor-pointer justify-center gap-2 w-[280px] font-medium text-sm text-[#7A7A7A]"
    ...
    >
      ...
      {isOpen && (
        <div
          className="absolute z-20 top-14 rounded-[5px] right-8 list-none bg-white rounded-lg shadow"
          id="user-dropdown"
          ref={ref}
        >
          <div className="px-4 py-3">
            <span className="block text-sm  text-gray-900 ">BESIX Group</span>
            <span className="block text-xs font-small text-gray-500 truncate ">
